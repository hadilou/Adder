...
#
# Generated by export_simulation on Thu Oct 10 20:59:54 +0300 2019
#
################################################################################
...
'-reset_run' switch to the './lab2_block.sh' script.

./lab2_block.sh -reset_run
...
./lab2_block.sh -noclean_files

For more information on the script, please type './lab2_block.sh -help'.
