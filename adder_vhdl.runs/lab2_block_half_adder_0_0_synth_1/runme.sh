...
HD_PWD='C:/Xilinx/Kayode/lab2/adder_vhdl/adder_vhdl.runs/lab2_block_half_adder_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab2_block_half_adder_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab2_block_half_adder_0_0.tcl
